...
import { checkOutVisa, rmoveAllCartItems } from '@/lib/servises/cart';
...
await checkOutVisa(cart?.cartId , formData)
...
<div className=' text-center text-2xl '>Pay with Visa&Master Card</div>
...
<Button onClick={() => router.push('/cart')} className='cursor-pointer rounded-full w-full'>COD Check Out</Button>
